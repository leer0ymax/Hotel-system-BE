import { createPaymentService, deletePaymentService, getAllPaymentsService, getAllPaymentsWithoutPaginationService, getPaymentByIdService, updatePaymentService } from "../../src/payment/payment.service";
