...
import { HotelTable } from '../../src/Drizzle/schema';
import { createHotelService, deleteHotelService, getAllHotelService, getHotelByIdService, updateHotelService } from '../../src/hotel/hotel.service';
